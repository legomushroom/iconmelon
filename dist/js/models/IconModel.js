...
(function() {
  ...
  define('models/IconModel', ['models/ProtoModel'], function(ProtoModel) {
    ...
    IconModel = (function(_super) {
      ...
      IconModel.prototype.select = function() {
        this.set('isSelected', true);
        return this.calcSelected();
      };

      IconModel.prototype.calcSelected = function() {
        App.iconsSelected = helpers.toggleArray(App.iconsSelected, "" + (this.collection.parentModel.get('name')) + ":" + (this.model.get('hash')));
        return App.vent.tigger('icon:select');
      };
