...
(function() {
  var Budget, BudgetSchema, DB_STR, Filter, FilterSchema, Main, Promise, Secret, SecretSchema, Section, SectionSchema, app, che, cookies, express, folder, fs, http, io, jade, main, markdown, md5, mkdirp, mongo, oneDay, path, port, pretty, zip, _;
