...
(function() {
  var Budget, BudgetSchema, DB_STR, Filter, FilterSchema, Main, Promise, Section, SectionSchema, app, che, express, fs, http, io, jade, main, markdown, md5, mkdirp, mongo, path, port, zip, _;
