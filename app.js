...
(function() {
  var Budget, BudgetSchema, DB_STR, Filter, FilterSchema, Main, Promise, Section, SectionSchema, app, che, express, fs, http, io, main, md5, mkdirp, mongo, path, port, zip, _;
  ...
  Main = (function() {
    ...
    Main.prototype.generateProductionSvgData = function(data) {
      var firstIcon, htmlData, htmlIcon, prm, svgData,
        _this = this;
      ...
      Section.find({
        ...
        var doc, i, icon, iconDB, icons, iconsDB, j, k, name, str, _i, _j, _k, _len, _len1, _len2;
        ...
        return Filter.find({
          ...
          var filterName, htmlStr, _l, _len3;
